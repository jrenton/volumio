...
<div class="container">
    ...
    <form class="form-horizontal" data-validate="parsley" action="" method="post">
        <fieldset>
            ...
            <p>Here you can select your desired output option. Default is onboard DAC, if any. At the moment, Volumio supports only one Output at the time. </p>
            <br>
            <div class="form-group">
			<label class="control-label" for="mixer-type">Audio Output</label>
			<div class="controls">
        ...
        <fieldset>
            ...
            <p>These are the global volume control settings. By default, Hardware Mixer is enabled. However, if you cannot set the Volume, switching to Software Volume Control will solve your issue, costing in decreased quality.</p>
            <br>
            <div class="form-group">
                ...
                <div class="controls">
					...
					<strong>Hardware</strong> - Works only with some DACS and enables volume control without affecting sound quality. Best of both worlds.<br>
                    <strong>Software</strong> - Works with every DAC available, but affectes audio quality.<br>
                    <strong>Disabled</strong> - No remote volume control available, preserves audio quality but harms couch potatoes.</span></span>
                </div>
            </div>
        </fieldset>
		...
		<fieldset>
            ...
            <div class="form-group" >
                ...
                <div class="controls">
                    <input class="input-large" class="input-large" type="text" id="port" name="conf[port]" value="$_mpd[port]" data-trigger="change" disabled>
            ...
            <div class="form-group" >
                ...
                <div class="controls">
				   <select id="log-level" name="conf[log-level]" class="input-large">
            ...
            <div class="form-group" >
                ...
                <div class="controls">
                    ...
                    <span class="help-block">If you have a problem with your MP3s ending abruptly it is recommended that you set this argument to "no" to attempt to fix the problem. </span>
                </div>
            </div>

			<div class="form-group" >
                <label class="control-label" for="dop">DSD over PCM</label>
                <div class="controls">
                    ...
                    <span class="help-block">Enable DSD over PCM, disabling direct DSD playback. Enable this only if DSD Playback doesn't work for you.</span>
                </div>
            </div>

			<div class="form-group" >
                <label class="control-label" for="dsd-usb">Volume normalization</label>
                <div class="controls">
            ...
            <div class="form-group" >
                <label class="control-label" for="port">Audio buffer size</label>
                <div class="controls">
                    <input class="input-large" class="input-large" type="text" id="audio-buffer-size" name="conf[audio_buffer_size]" value="$_mpd[audio_buffer_size]" data-trigger="change">
			...
			<div class="form-group" >
                <label class="control-label" for="dsd-usb">Buffer before play</label>
                <div class="controls">
            ...
            <div class="form-group">
                ...
                <div class="controls">
                    ...
                    <span class="help-block">This setting enables automatic update of music database when files in music_directory are changed.</span>
                </div>
            </div>
            <!-- <div class="form-group">
                <label class="control-label" for="auto-update-depth">Auto update depth</label>
                <div class="controls">
                    <input class="input-large" class="form-control" type="text" id="auto-update-depth" name="conf[auto_update_depth]" value="$_mpd[auto_update_depth]" data-trigger="change">
                    <span class="help-block">Limit the depth of the directories being watched, 0 means only watch the music directory itself. Leave blank for default (no limit).</span>
                </div>
            </div> -->
        </fieldset>
      <!--  <fieldset>
            <legend>Zeroconf / Avahi Service Discovery</legend>
            <div class="form-group">
                ...
                <div class="controls">
                    ...
                    <span class="help-block">If this setting is set to "yes", service information will be published with Zeroconf / Avahi.</span>
                </div>
            </div> 
            <div class="form-group">
                ...
                <div class="controls">
                    ...
                    <span class="help-block">The argument to this setting will be the Zeroconf / Avahi unique name for this MPD server on the network.</span>
                </div>
            </div>
        </fieldset>-->
		<fieldset>
            ...
            <p>Here you can set Up or Downsampling. Set the desired bit-depth and resolution and the desired Resampling algorithm.</p>
            <br>
			<div class="form-group">
			<label class="control-label" for="audio-output-format">Audio output format (resampling)</label>
				<br>
                <div class="controls">
                    ...
                    <span class="help-block">This setting will change all decoded audio to be converted to the specified format before being passed to the audio outputs. By default, this setting is disabled.</span>
                </div>
				 </div>
            <div class="form-group">
                ...
                <div class="controls">
                    ...
                    <select id="samplerate_converter" name="conf[samplerate_converter]" class="input-large">
                        
						$_mpd_select[samplerate_converter]
                    </select>

                    <span class="help-block">
					<strong>Best Sinc Interpolator:</strong> Band limited sinc interpolation, best quality, 97dB SNR, 96% BW.<br>
					<strong>Medium Sinc Interpolator:</strong> Band limited sinc interpolation, medium quality, 97dB SNR, 90% BW.<br>
					<strong>Fastest Sinc Interpolator:</strong> Band limited sinc interpolation, fastest, 97dB SNR, 80% BW.<br>
