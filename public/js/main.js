...
module.exports = {
    ...
    methods: {
        ...
        getAlbumArtist: function getAlbumArtist(file) {
            var albumArtist = "";
...
},{"../services/musicPlayerService":14,"../services/queueService":15,"../store":17,"./browse.html":5,"lodash":1}],7:[function(require,module,exports){
"use strict";
...
},{"../services/musicPlayerService":14,"../services/timeControl":16,"../store":17,"./playback.html":8}],10:[function(require,module,exports){
module.exports = '<div class="tab-content">\n	<div id="playlist">\n		<ul class="playlist">\n			<li id="pl-{{ song.index }}" v-for="song in playlist.songs">\n				<div class="pl-action">\n					<a title="Remove song from playlist" v-on:click="removeFromPlaylist(song)">\n						<i class="fa fa-trash"></i>\n					</a>\n				</div>\n				<div class="pl-entry" v-on:click="playSong(song)">\n					{{ song.title }}\n					<span>\n						{{ song.artist }} - {{ song.album }}\n					</span>\n				</div>\n			</li>\n			<li id="pl-{{ song.index }}" v-for="song in queue.songs">\n				<div class="pl-action" v-on:click="removeFromQueue(song)">\n					<a title="Remove song from playlist" v-on:click="removeFromQueue(song)">\n						<i class="fa fa-trash"></i>\n					</a>\n				</div>\n				<div class="pl-entry" v-on:click="play(song)">\n					{{ song.title }}\n					<span>\n						{{ song.artist }} - {{ song.album }}\n					</span>\n				</div>\n			</li>\n		</ul>\n	</div>\n</div>';
...
module.exports = {
				...
				methods: {
								...
								removeSpotifySong: function removeSpotifySong(song) {
												sendCommand("spop-qrm", { "path": song.index }, function (data) {
																console.log(data);
																getPlaylist();
												});
								},
								playMpdSong: function playMpdSong(song) {
												sendCmd("play " + song.index);
								},
								removeMpdSong: function removeMpdSong(song) {
												sendCmd("trackremove&songid=" + song.index);
								}
				}
};

},{"../store":17,"./playlist.html":10}],12:[function(require,module,exports){
"use strict";
...
module.exports = {
    ...
    showCoverArt: function showCoverArt(song) {
        if (!song) {
            return;
        }
...
},{"../services/currentSongService":13,"./ajaxUtilsService":12}],15:[function(require,module,exports){
"use strict";
...
module.exports = {
    addSongs: function addSongs(songs) {
...
},{"../store":17,"./musicPlayerService":14}],16:[function(require,module,exports){
'use strict';
