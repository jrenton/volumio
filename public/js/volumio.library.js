...
function filterLib(forceShowAll) {
  ...
  var newFilters = checkFilters(library.filters.albums, library.allAlbums, function(o) {
    return keyAlbum(o);
  });
  ...
  newFilters = checkFilters(library.filters.artists, library.allArtists, function(o) {
    return o;
  });
  ...
  if (needReload) {
    ...
    library.allAlbums.sort(function(a, b) {
      return a.album.toLowerCase() > b.album.toLowerCase() ? 1 : -1;
    });
    library.allAlbums = removeDuplicate([{
        "album": "All albums",
        "artist": ""
      }].concat(library.allAlbums),
      function(a, b) {
        return a.album === b.album && a.artist === b.artist;
      });
  }
}
...
jQuery(document).ready(function($) {
  ...
  $('#songsList').on('click', '.lib-play', function(e) {
    ...
    sendCommand('addreplaceplay', {
      path: library.allSongs[pos].file
    });
